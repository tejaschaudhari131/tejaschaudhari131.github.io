                ...
                <div className="md:col-span-7 mt-12 md:mt-0 pl-0 md:pl-12">
                    ...
                    <div className="bg-gray-900 rounded-xl overflow-hidden mb-8 relative group aspect-square shadow-2xl">
                        ...
                        <img
                            ...
                            className="w-full h-full object-cover object-top opacity-90 transition-all duration-700 md:filter md:grayscale md:contrast-125 md:group-hover:filter-none md:group-hover:opacity-100 md:group-hover:scale-105"
                        />
